  ...
  _createClass(IconList, [{
    ...
    value: function renderList(data) {
      ...
      return data.map(function (item, i) {
        var todos = ['fav', 'del'];
        return _react2.default.createElement(_Icon2.default, { info: item, todos: todos });
      });
    }
  }, {
    key: 'fetchDates',
...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function favIcon(e) {
      var id = e.target.getAttribute("id");
      var _ifont_fav_icons = _store2.default.get("_ifont_fav_icons") || [];
      _ifont_fav_icons.push({
        id: id
      });
      _store2.default.set("_ifont_fav_icons", _ifont_fav_icons); //设置
    }
    /**
     * 组件生命周期：正在渲染
     * @returns {XML}
...
//# sourceMappingURL=Lib.e3549735.js.map