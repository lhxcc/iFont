  ...
  _createClass(Icon, [{
    ...
    value: function renderTodos(todos) {
      ...
      todos.map(function (item) {
        ...
        switch (item) {
          case 'del':
            todosHTML.push('<span title="删除" className="cover-item iconfont cover-item-line icon-delete" />');
            break;
          case 'fav':
            todosHTML.push('<span title="添加入库" className="cover-item iconfont cover-item-line icon-favorite" />');
            break;
        }
      });
      return todosHTML;
...
//# sourceMappingURL=Lib.bd5989f1.js.map