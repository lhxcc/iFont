              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      'span',
                      { id: 'J_icon_fav_count', className: 'icon-fav-count1 ' + (this.refreshing ? 'count-ani' : '') },
                      this.state.count
                    )
                  )
                ),
...
var _jquery = __webpack_require__(386);
...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function favIcon(e) {
      ...
      // const J_icon_fav_count = $("J_icon_fav_count");
      // J_icon_fav_count.addClass("count-ani").html(len);
      // setTimeout(() => {
      //   J_icon_fav_count.removeClass("count-ani");
      //   //J_icon_fav_count.innerText = len;
      // },1000)
      this.props.refreshHeadIconCount();
    }
    /**
     * 组件生命周期：正在渲染
     * @returns {XML}
...
//# sourceMappingURL=Lib.1b16fcd9.js.map