  ...
  _createClass(Icon, [{
    ...
    value: function renderTodos(todos, info) {
      ...
      return todos.map(function (item) {
        ...
        return _react2.default.createElement('span', { key: info.id, id: info.id, title: btnTitle, onClick: btnEvt, className: 'cover-item iconfont ' + btnIcon + ' ' + coverItemCls });
      });
    }
  }, {
    key: 'delIcon',
...
//# sourceMappingURL=Lib.653f2113.js.map