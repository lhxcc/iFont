  ...
  _createClass(Icon, [{
    ...
    value: function renderTodos(todos, info) {
      ...
      return todos.map(function (item) {
        ...
        return _react2.default.createElement('span', { keyinfo: { info: info }, title: btnTitle, onClick: btnEvt, className: 'cover-item iconfont ' + btnIcon + ' ' + coverItemCls });
      });
    }
  }, {
    key: 'delIcon',
    ...
    value: function favIcon(e) {
      var info = e.target.getAttribute("keyinfo");
...
//# sourceMappingURL=Lib.c6093c88.js.map