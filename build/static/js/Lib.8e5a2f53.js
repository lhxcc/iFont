...
var _omit = __webpack_require__(386);
...
var _ScrollableInkTabBar = __webpack_require__(393);

var _ScrollableInkTabBar2 = _interopRequireDefault(_ScrollableInkTabBar);

var _TabContent = __webpack_require__(396);
  ...
  _createClass(IconList, [{
    ...
    value: function renderList(data) {
      ...
      return data.map(function (item, i) {
        var todos = ['fav', 'del'];
        return _react2.default.createElement(_Icon2.default, { key: item.id, info: item, todos: todos });
      });
    }
  }, {
    key: 'fetchDates',
...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function componentWillMount() {
      ...
      var isFoved = false;
      var oInfo = this.props.info;
      ifontFavIcons.map(function (item) {
        if (item.id == oInfo.id) {
          isFoved = true;
        }
      });
      oInfo.isFoved = isFoved;
      this.setState({
        info: oInfo
      });
    }
    ...
    value: function renderTodos(todos, info) {
      ...
      return todos.map(function (item) {
        ...
        return _react2.default.createElement('span', { key: 'btnIcon_' + info.id, id: info.id, title: btnTitle, onClick: btnEvt, className: 'cover-item iconfont ' + btnIcon + ' ' + coverItemCls });
      });
    }
  }, {
    key: 'delIcon',
    ...
    value: function favIcon(e) {
      ...
      _store2.default.set("_ifont_fav_icons", ifontFavIcons); //设置
    }
    /**
     * 组件生命周期：正在渲染
     * @returns {XML}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils__ = __webpack_require__(391);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__KeyCode__ = __webpack_require__(387);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tabs__ = __webpack_require__(389);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TabPane__ = __webpack_require__(320);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TabContent__ = __webpack_require__(388);
...
var _InkTabBarMixin = __webpack_require__(392);

var _InkTabBarMixin2 = _interopRequireDefault(_InkTabBarMixin);

var _ScrollableTabBarMixin = __webpack_require__(394);

var _ScrollableTabBarMixin2 = _interopRequireDefault(_ScrollableTabBarMixin);

var _TabBarMixin = __webpack_require__(395);
...
//# sourceMappingURL=Lib.8e5a2f53.js.map