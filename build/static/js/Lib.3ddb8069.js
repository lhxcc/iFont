  ...
  _createClass(Icon, [{
    ...
    value: function renderTodos(todos, info) {
      ...
      return todos.map(function (item) {
        ...
        return _react2.default.createElement('span', { id: info.id, title: btnTitle, onClick: btnEvt, className: 'cover-item iconfont ' + btnIcon + ' ' + coverItemCls });
      });
    }
  }, {
    key: 'delIcon',
...
//# sourceMappingURL=Lib.3ddb8069.js.map