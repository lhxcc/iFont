  ...
  _createClass(Icon, [{
    ...
    value: function renderTodos(todos) {
      ...
      todos.map(function (item) {
        ...
        switch (item) {
          case 'del':
            todosHTML.push(_react2.default.createElement('span', { title: '\u5220\u9664', className: 'cover-item iconfont cover-item-line icon-delete' }));
            break;
          case 'fav':
            todosHTML += '<span title="添加入库" className="cover-item iconfont cover-item-line icon-favorite" />';
            break;
        }
      });
      return todosHTML;
...
//# sourceMappingURL=Lib.76e5848a.js.map