...
const createDemoZip = (outputDir, done) => {
  ...
  const list = [
    { name: `${zipDir}/iconfont.html` , path: `${outputDir}/iconfont.html`},
    { name: `${zipDir}/iconfont.css` , path: `${outputDir}/iconfont.css`},
    { name: `${zipDir}/iconfont.svg` , path: `${outputDir}/iconfont.svg`},
    { name: `${zipDir}/iconfont.ttf` , path: `${outputDir}/iconfont.ttf`},
    { name: `${zipDir}/iconfont.eot` , path: `${outputDir}/iconfont.eot`},
    { name: `${zipDir}/iconfont.woff` , path: `${outputDir}/iconfont.woff`},
    { name: `${zipDir}/iconfont.woff2` , path: `${outputDir}/iconfont.woff2`}
  ];
